 ...
 *    <dd>Este identificador es unico para cada comercio. Se provee al comercio
 * tras la firma del contrato de utilizacion del sistema de pago. </dd>
 *    <dt>Importe</dt>
 ...
 * no sean correcto (ej. pagos negativos) se intepretara; la peticion
...
public class ComienzaPago extends ServletRaiz {
    ...
    /**
     * Parametro que indica el identificador de transaccion
     */
    public final static String PARAM_ID_TRANSACCION = "idTransaccion";

    /**
     * Parametro que indica el identificador de comercio
     */
    public final static String PARAM_ID_COMERCIO = "idComercio";

    /**
     * Parametro que indica el importe del pago
     */
    public final static String PARAM_IMPORTE = "importe";

    /**
     * Parametro que indica la ruta de retorno
     */
    ...
    /**
    * Procesa una peticion HTTP tanto <code>GET</code> como <code>POST</code>.
   ...
   /**
    * Procesa una peticion HTTP <code>GET</code>.
    * @param request objeto de peticion
    * @param response objeto de respuesta
    */
    @Override
    ...
    /**
    * Procesa una peticion HTTP <code>POST</code>.
    * @param request objeto de peticion
    * @param response objeto de respuesta
    */
    @Override
    ...
    */
    ...
    /**
    * Crea un bean de pago a partir de los parametros de la peticion.
    * @param request objeto de peticion
    ...
    */
    private PagoBean creaPago(HttpServletRequest request) {
        ...
        try{
            ...
            errorLog("Error al recibir la IP");
        }
        /*Añadido P3*/
        double impd=-1.0;
        try {
    ...
    /**
    * Comprueba si una cadena de caracteres es vacia o nula.
    * @param s cadena de caracteres
    * @return verdadero si es vacia o nula, falso en caso contrario
    */
    ...
    /**
    * Devuelve una descripicion abreviada del servlet
    */
    @Override
